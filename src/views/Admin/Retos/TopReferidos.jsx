...
function TopReferidosForm({ 
  ...
  const handleDelete = async (referidoId, nombreCompleto) => {
    const confirmDelete = window.confirm(
      `¿Estás seguro de eliminar el registro de ${nombreCompleto} del top de referidos?`
    );
    ...
    try {
      await axios.patch(
        `https://backbetter-production.up.railway.app/top-referidos/eliminar/${referidoId}`
      );
